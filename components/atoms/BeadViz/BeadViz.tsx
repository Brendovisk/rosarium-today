        ...
        >
          <defs>
            ...
            <radialGradient id="bvBead" cx="32%" cy="28%" r="75%">
              <stop offset="0%" stopColor="color-mix(in oklab, var(--gold) 40%, white)" />
              <stop offset="28%" stopColor="color-mix(in oklab, var(--gold) 72%, white)" />
              <stop offset="65%" stopColor="var(--gold)" />
              <stop offset="100%" stopColor="color-mix(in oklab, var(--gold) 34%, black)" />
            </radialGradient>
            <radialGradient id="bvBeadDark" cx="32%" cy="28%" r="75%">
              <stop offset="0%" stopColor="color-mix(in oklab, var(--gold) 36%, var(--muted))" />
              <stop offset="45%" stopColor="color-mix(in oklab, var(--gold) 18%, var(--ink-3))" />
              <stop offset="100%" stopColor="color-mix(in oklab, var(--gold) 8%, var(--ink))" />
            </radialGradient>
            <radialGradient id="bvBeadHover" cx="32%" cy="28%" r="75%">
              <stop offset="0%" stopColor="color-mix(in oklab, var(--gold) 52%, var(--bone))" />
              <stop offset="55%" stopColor="color-mix(in oklab, var(--gold) 38%, var(--ink-3))" />
              <stop offset="100%" stopColor="color-mix(in oklab, var(--gold) 12%, var(--ink))" />
            </radialGradient>
          ...
          <path d={pathD} fill="none" stroke="var(--gold-dim)" strokeWidth="0.35" strokeLinejoin="round" />
          <path d={pendantPath} fill="none" stroke="var(--gold-dim)" strokeWidth="0.35" strokeLinecap="round" />
            ...
            return (
              <g key={i}>
                <circle
                  ...
                  r={radius}
                  fill={fill}
                  stroke={isActive ? "color-mix(in oklab, var(--gold) 70%, white)" : "none"}
                  strokeWidth="0.3"
