...
export function PrayerRail({
  ...
  return (
    <aside
      className={cn(
        "relative hidden xl:flex flex-col border-t border-line bg-black/10 px-5 pt-6 pb-[2.75rem] transition-[padding] duration-300 xl:border-l xl:border-t-0",
        collapsed ? "xl:px-2.5" : "xl:px-7"
      )}
    >
      <button
        onClick={onToggle}
        className={cn(
          "absolute top-5 hidden size-8 place-items-center rounded-full border border-line bg-ink-2 text-muted transition-colors hover:border-gold-dim hover:text-gold xl:grid",
      ...
      {collapsed ? (
        <div className="hidden h-full flex-col items-center pt-12 xl:flex">
        ...
        <>
          ...
          <div className="mt-auto hidden border-t border-line pt-6 text-center font-display text-sm italic text-muted-2 xl:block">
