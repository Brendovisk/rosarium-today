...
describe("ROSARY_STEPS", () => {
  // 7 opening + 5 × (1 announcement + 1 paterNoster + 10 aveMaria + 1 gloria + 1 oratio + 1 miraculousMedal) + 2 closing
  const EXPECTED_TOTAL =
    7 + DECADES_PER_ROSARY * (1 + 1 + AVE_MARIAS_PER_DECADE + 1 + 1 + 1) + 2;
